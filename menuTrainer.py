...
def menuTrainer(trainer):
    ...
    if opcion == "2":
        ...
        if encontrado == False:
            ...
            opcionG = input("Escribe el ID del grupo: ")
            grupo_sel = None
                ...
                if len(grupo_sel["campers"]) == 0:
                    ...
                    for i in range(len(grupo_sel["campers"])):
                        ...
                        if camper_sel == None:
                            ...
                            actividad = float(input("Actividad (30%): "))
                            practica = float(input("Evaluacion practica (40%): "))
                            teorica = float(input("Evaluacion teorica (30%): "))

                            definitiva = (actividad * 0.3) + (practica * 0.4) + (teorica * 0.3)

                            modulo_sel["notas"][str(id_camper)] = {
                                "actividad": actividad,
                                "practica": practica,
                                "teorica": teorica,
